...
<template>
  <view
    class="class t-class l-tab-bar fz-16px flex flex-nowrap items-center box-border bg-[--l-tab-bar-bg-color,theme(bg-color-container)] b-t-color-[--l-tab-bar-border-color,theme(border-color)] shadow-[--l-tab-bar-round-shadow,theme(shadow-3)]"
    :class="{
